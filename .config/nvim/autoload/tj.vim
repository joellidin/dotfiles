"" Taken from https://github.com/tjdevries/config_manager/blob/master/xdg_config/nvim/autoload/tj.vim
...
" vnoremap yc <c-r>:call tj#visual_code_review()<CR> " Does not work?
