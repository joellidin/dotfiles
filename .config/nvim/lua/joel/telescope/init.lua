-- breks plugin for some reason when true. Check videos.
...
local reloader = function()
  if SHOULD_RELOAD_TELESCOPE then
    ...
    RELOAD "popup"
    RELOAD "telescope"
    RELOAD "joel.telescope.setup"
    RELOAD "joel.telescope.custom"
  end
end
...
return setmetatable({}, {
  __index = function(_, k)
    ...
    local has_custom, custom = pcall(require, string.format("joel.telescope.custom.%s", k))
